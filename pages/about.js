  ...
  return (
    <>
      ...
      <main className="bg-gradient-to-br from-[#f0fdf4] via-white to-[#e6f4ea] text-gray-900 min-h-screen py-16 px-6 md:px-12">
        ...
        {/* Legal & Contact Info */}
        <section className="max-w-4xl mx-auto bg-green-50 rounded-3xl shadow-xl p-10 mb-24 text-center hover:shadow-2xl transition">
          <h2 className="text-2xl font-bold text-green-700 mb-2">Legal & Contact</h2>
          <div className="h-1 w-12 bg-green-600 mx-auto mb-6 rounded-full" />
          <p className="text-gray-700 mb-2">Registered with: Social Welfare Department, Government of KPK</p>
          <p className="text-gray-700 mb-2">Head Office: Machipura, Jabri Kalish, Tehsil Balakot, District Mansehra</p>
          <p className="text-gray-700 mb-2">Founder: Sardar Mushtaq Hussain</p>
          <p className="text-gray-700">Phone: 0344-9513020</p>
        </section>
